...
try:
    ...
    from .models.filmpalast_to.shared import (
    ...
    from aniworld.models.filmpalast_to.shared import (
        group_filmpalast_search_results,
        search_filmpalast_entries,
    )
...
def query_filmpalast(keyword):
    """Search filmpalast.to and group episodic entries into pseudo series."""
    return group_filmpalast_search_results(search_filmpalast_entries(keyword))
